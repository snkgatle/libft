...
ft_toupper.c ft_strmap.c ft_strmapi.c
OBJ = ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o ft_isascii.o ft_isdigit.o\
ft_isprint.o ft_itoa.o ft_memalloc.o ft_memccpy.o ft_memcpy.o ft_memchr.o\
...
ft_putstr_fd.o ft_strcat.o ft_strchr.o ft_strclr.o ft_strcmp.o ft_strncmp.o\
ft_strcpy.o ft_strdel.o ft_strdup.o ft_strequ.o ft_strnequ.o ft_striter.o\
ft_striteri.o ft_strjoin.o ft_strlcat.o ft_strlen.o ft_strncat.o ft_strncmp.o\
ft_strncpy.o ft_strnequ.o ft_strnew.o ft_strnstr.o ft_strrchr.o ft_strsplit.o\
ft_strstr.o ft_strsub.o ft_strtrim.o ft_tolower.o ft_toupper.o ft_strmap.o\
ft_strmapi.o
all: $(NAME)
$(NAME): $(OBJEC)
	$(CC) $(CFLAGS)  $(CFILES)
